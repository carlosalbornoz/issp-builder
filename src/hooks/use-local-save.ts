 ...
 */
export function useLocalSave<K extends PartKey>(part: K) {
  const { updatePart1, updatePart2, updatePart3, updatePart4, saveStatus } = useIsspStore();
  ...
  const debouncedSave = useCallback(
    ...
    [part, updatePart1, updatePart2, updatePart3, updatePart4]
  );
