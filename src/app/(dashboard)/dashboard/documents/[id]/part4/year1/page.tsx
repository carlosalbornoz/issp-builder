...
export default async function Part4Year1Page({
  params,
}: {
  ...
  // Pull project lists from Part III
  ...
  const year1Data = doc.part4
    ? (JSON.parse(doc.part4.year1 || "{}") as YearBudget)
    : null;
