  ...
  const internalProjects = [
    {
      ...
      strategicAlignment: ["Digital Philippines", "Ease of Doing Business"],
      harmonization: ["DICT ICT Harmonization", "Government Cloud Program"],
      duration: "2026–2027",
    ...
    },
    {
      ...
      linkedSystemIds: [],
      strategicAlignment: ["Digital Philippines", "Regional Development Agenda"],
      harmonization: ["DICT National Broadband Plan"],
      duration: "2026",
    ...
    },
    {
      ...
      strategicAlignment: ["Good Governance", "Digital Philippines"],
      harmonization: ["CSC HRMIS Integration Program", "DBM eBudget Rollout"],
      duration: "2026",
