...
| PDF export | Done | Cover, TOC, definitions, Parts I-IV, running header/footer, UACS budget tables. |
...
| API routes | `src/app/api/export/route.ts` only | Stateless PDF export endpoint. |
